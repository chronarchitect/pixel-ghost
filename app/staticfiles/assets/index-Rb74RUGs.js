...
var root_1 = /* @__PURE__ */ from_html(`<p>Please enter your name above.</p>`);
var root_2 = /* @__PURE__ */ from_html(`<p> </p>`);
var root = /* @__PURE__ */ from_html(`<main><p>What is your name?</p> <form><input placeholder="Enter your name"/></form> <!></main>`);
function App($$anchor) {
  let name = /* @__PURE__ */ mutable_source("");
  var main = root();
